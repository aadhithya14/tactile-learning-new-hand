...
from tactile_learning.models.utils import init_encoder_info
...
class BETDataset(data.Dataset):
    def __init__(
        ...
        view_num = 1, # View number to use for image
    ):
        
        os.environ["MASTER_ADDR"] = "localhost"
        os.environ["MASTER_PORT"] = "29505"

        torch.distributed.init_process_group(backend='gloo', rank=0, world_size=1) # This is needed to load the encoders
        ...
        self.data = load_data(self.roots) # This will return all the desired indices and the values
